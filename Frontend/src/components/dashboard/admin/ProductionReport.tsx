...
import { Download, ChevronLeft, ChevronRight, Wheat, Calendar, TrendingUp, Filter, X, ChevronDown, FileText } from "lucide-react";
...
const ProductionReport = ({ onExport }: ProductionReportProps) => {
    ...
    const handleExportProduction = (exportType: 'page' | 'all', format: 'csv' | 'pdf' | 'excel') => {
        ...
        const dataToExport = rawData.map(record => ({
            ...
            'Est. Yield Harvest (kg)': Math.round(record.quantity),
        ...
        const filename = `production_report_${exportType === 'page' ? `page${currentPage}` : 'all'}_${new Date().toISOString().split('T')[0]}`;
        ...
        if (format === 'csv') {
            ...
            autoTable(doc, {
                startY: 45,
                head: [['Farmer Name', 'Farm Address', 'Harvested Crop', 'Land Area (ha)', 'Est. Yield Harvest (kg)', 'Harvest Date']],
                                ...
                                >
                                    ...
                                    <AccordionItem value="pdf" className="border-b-0">
                                        ...
                                        <AccordionContent className="pb-0">
                                            <DropdownMenuItem 
                                                onClick={() => handleExportProduction('page', 'pdf')} 
                                            ...
                                            <DropdownMenuItem 
                                                onClick={() => handleExportProduction('all', 'pdf')} 
                                                className="hover:bg-blue-50 hover:text-blue-700 cursor-pointer"
                                                onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = '#eff6ff'; e.currentTarget.style.color = '#1d4ed8'; }}
                                                onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = ''; e.currentTarget.style.color = ''; }}
                                            >
                                    ...
                                    <AccordionItem value="excel" className="border-b-0">
                                        ...
                                        <AccordionContent className="pb-0">
                                            <DropdownMenuItem 
                                                onClick={() => handleExportProduction('page', 'excel')} 
                                                className="hover:bg-blue-50 hover:text-blue-700 cursor-pointer"
                                                onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = '#eff6ff'; e.currentTarget.style.color = '#1d4ed8'; }}
                                                onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = ''; e.currentTarget.style.color = ''; }}
                                            >
                                            ...
                                            <DropdownMenuItem 
                                                onClick={() => handleExportProduction('all', 'excel')} 
                                                className="hover:bg-blue-50 hover:text-blue-700 cursor-pointer"
                                                onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = '#eff6ff'; e.currentTarget.style.color = '#1d4ed8'; }}
                                                onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = ''; e.currentTarget.style.color = ''; }}
                                            >
                                    ...
                                    <AccordionItem value="csv" className="border-b-0">
                                        ...
                                        <AccordionContent className="pb-0">
                                            <DropdownMenuItem 
                                                onClick={() => handleExportProduction('page', 'csv')} 
                                                className="hover:bg-blue-50 hover:text-blue-700 cursor-pointer"
                                                onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = '#eff6ff'; e.currentTarget.style.color = '#1d4ed8'; }}
                                                onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = ''; e.currentTarget.style.color = ''; }}
                                            >
                                            ...
                                            <DropdownMenuItem 
                                                onClick={() => handleExportProduction('all', 'csv')} 
                                                className="hover:bg-blue-50 hover:text-blue-700 cursor-pointer"
                                                onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = '#eff6ff'; e.currentTarget.style.color = '#1d4ed8'; }}
                                                onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = ''; e.currentTarget.style.color = ''; }}
                                            >
