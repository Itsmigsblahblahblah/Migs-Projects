                ...
                <div className="mt-6">
                    ...
                    <div className="mt-4 p-4 bg-muted/50 rounded-lg">
                        ...
                        <div className="mt-3 p-3 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
                            <p className="text-xs text-black font-medium break-words">Disclaimer: This forecast is based on historical data and market trends. Actual results may vary due to factors such as weather conditions, market fluctuations, and other unforeseen circumstances. This projection should be used as a guide only and not as a guarantee of income.</p>
                        </div>
                    </div>
                </div>
            </CardContent>
